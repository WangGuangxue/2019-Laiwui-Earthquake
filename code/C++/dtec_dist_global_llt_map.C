...
TLatex *t000 = new TLatex();
   ...
   t000->DrawLatex(-172,90,"2019/07/06 06:00-08:00 UT (15:00-17:00 LT) LLT map");
...
TLatex *t020 = new TLatex();
   ...
   t020->DrawLatex(90.,20.,"2019/07/06 06:00-08:00 UT difference LLT (|#DeltaTEC|>2.0) map");
...
TLatex *t100 = new TLatex();
   ...
   t100->DrawLatex(-173,90,"2019/07/11 08:00-10:00 UT (17:00-19:00 LT) LLT map");
...
TLatex *t120 = new TLatex();
   ...
   t120->DrawLatex(90.,20.,"2019/07/11 08:00-10:00 UT difference LLT (|#DeltaTEC|>2.0) map");
...
TLatex *t200 = new TLatex();
   ...
   t200->DrawLatex(-173,90,"2019/07/13 06:00-08:00 UT (15:00-17:00 LT) LLT map");
...
h22->GetZaxis()->SetLabelSize(0.047);
