...
geoshow('landareas.shp', 'FaceColor', 'none');
 hold on
scatterm(select_day_data_0712(:,11),select_day_data_0712(:,10),25,(select_day_data_0712(:,8)-Ne_mean)/Ne_mean,'filled')
scatterm(select_day_data_0713(:,11),select_day_data_0713(:,10),25,(select_day_data_0713(:,8)-Ne_mean)/Ne_mean,'filled')
scatterm(select_day_data_0711(:,11),select_day_data_0711(:,10),25,(select_day_data_0711(:,8)-Ne_mean)/Ne_mean,'filled')
scatterm(select_day_data_0710(:,11),select_day_data_0710(:,10),25,(select_day_data_0710(:,8)-Ne_mean)/Ne_mean,'filled')
...
% title('Electron Density (Ascending Orbits)','fontname','times new
% roman','fontsize',15)